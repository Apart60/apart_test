...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" onParamsReceive="modelParamsReceive"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="false"
      ...
      <column label="创建人" name="create_by" type="String" xid="default21"/>  
      <column label="创建时间" name="create_time" type="DateTime" xid="default22"/>  
      ...
      <column label="往来单位编号" name="customercode" type="String" xid="default28"/>  
      <column label="往来单位名称" name="customername" type="String" xid="default29"/>  
      <column label="仓库编号" name="housecode" type="String" xid="default30"/>  
      <column label="仓库名称" name="housename" type="String" xid="default31"/>  
      <column label="员工编号" name="staffcode" type="String" xid="default32"/>  
      <column label="员工姓名" name="staffname" type="String" xid="default33"/> 
    </div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="false"
      xid="schedulePickDetailData" limit="6" confirmDelete="false" confirmRefresh="false"
      idColumn="detailid" orderBy="goods_number:asc" onAfterRefresh="schedulePickDetailDataAfterRefresh" onCustomRefresh="schedulePickDetailDataCustomRefresh"> 
      ...
      <column label="商品条码" name="barcode" type="String" xid="default41"/>  
      ...
      <column label="主表编号" name="schedule_pick_id" type="String" xid="default49"/>  
      <column label="序号" name="goods_number" type="Integer" xid="default50"/>  
      <column label="企业编号" name="companyid" type="String" xid="default51"/>  
      <column label="单据日期" name="operate_time" type="Date" xid="default52"/>  
      <column label="经手人" name="operate_by" type="String" xid="default53"/>  
      <column label="单据编号" name="orderid" type="String" xid="default54"/>  
      <column label="商品编号" name="itemid" type="String" xid="default55"/>  
      <column label="仓库" name="houseid" type="String" xid="default56"/>  
      <column label="单位部门" name="customerid" type="String" xid="default57"/>  
      <column label="类型" name="stype" type="String" xid="default58"/>  
      <column label="数量" name="count" type="Double" xid="default59"/>  
      <column label="单价" name="price" type="Double" xid="default60"/>  
      <column label="金额" name="total" type="Double" xid="default61"/>  
      <column label="状态" name="status" type="String" xid="default62"/>  
      <column label="备注" name="remark" type="String" xid="default63"/>  
      <column label="创建人ID" name="create_id" type="String" xid="default64"/>  
      <column label="创建人" name="create_by" type="String" xid="default65"/>  
      <column label="创建时间" name="create_time" type="DateTime" xid="default66"/>  
      <column label="更新人ID" name="update_id" type="String" xid="default67"/>  
      <column label="更新人" name="update_by" type="String" xid="default68"/>  
      <column label="更新时间" name="update_time" type="DateTime" xid="default69"/>  
      <column label="原单号" name="originalbill" type="String" xid="default70"/>  
      <column label="批号" name="batchno" type="String" xid="default71"/>  
      <column label="辅助单位1状态" isCalculate="true" name="unitstate1" type="Integer"
        xid="unit1"/>  
      <column label="辅助单位2状态" isCalculate="true" name="unitstate2" type="Integer"
        xid="unit2"/>  
      <column label="辅助单位3状态" isCalculate="true" name="unitstate3" type="Integer"
        xid="unit3"/>  
      <column label="辅助单位1设置" isCalculate="true" name="unitset1" type="String"
        xid="unit4"/>  
      <column label="辅助单位2设置" isCalculate="true" name="unitset2" type="String"
        xid="unit5"/>  
      <column label="辅助单位3设置" isCalculate="true" name="unitset3" type="String"
        xid="unit6"/>  
      <column label="辅助单位1换算" isCalculate="true" name="counttounit1" type="String"
        xid="unit7"/>  
      <column label="辅助单位2换算" isCalculate="true" name="counttounit2" type="String"
        xid="unit8"/>  
      <column label="辅助单位3换算" isCalculate="true" name="counttounit3" type="String"
        xid="unit9"/> 
    </div>  
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <column name="title" type="String" xid="column19"/>  
      ...
      <data xid="default72">[{"type":"1"}]</data> 
    </div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" title="排产领料单打印"
        class="x-titlebar" xid="titleBar1" style="background-color:white;"> 
        <div class="x-titlebar-title flex1" xid="title1" style="color:#4F77AA;">排产领料单打印</div>  
    ...
    <div class="x-panel-content" xid="content1" style="padding:10px;"> 
      <div component="$UI/system/components/justep/pagerBar/pagerBar" class="x-pagerbar container-fluid"
        xid="pagerBar1" data="schedulePickDetailData" style="margin:2px;"> 
          ...
          <div xid="div20" style="vertical-align:middle;text-align:center;height:100%;width:100%;"
            ...
            <div xid="div17" align="center" style="position: relative;display:flex;flex-direction:row;justify-content: center;align-items:center;width:100%;height:60px;"> 
              <div xid="div16" class="imageshow" style="margin-right:5px;"> 
                <img src=" " alt="" xid="image1" height="55px" style="width:auto;"/> 
              </div>  
              <div xid="div18" style="width:auto;"> 
                <div component="$UI/system/components/justep/row/row" class="x-row"
                  xid="row7" style="padding:0px;margin:0px;height:33px;"> 
                  <div class="x-col x-col-fixed x-col-bottom titlecss" xid="col1"
                    style="width:100%;" bind-text=" $model.pdata.val(&quot;title&quot;)"/> 
                </div>  
                <div component="$UI/system/components/justep/row/row" class="x-row"
                  xid="row7" style="padding:0px;margin:0px;height:22px;" bind-visible=" "> 
                  <div class="x-col x-col-fixed x-col-top addresscss" xid="col1"
              ...
              <div xid="qrcodediv" align="center" style="display: block;justify-content:center;align-items:center;position: absolute;right:20px;height:75px;width:75px;top:-11px;"> 
                <div component="$UI/system/components/justep/qrcode/qrcode"
                  xid="qrcode2" bind-content=" $model.schedulePickData.val(&quot;orderid&quot;)"
                  style="height:1.8cm;width:1.8cm;"/> 
              </div> 
            </div>  
            <div component="$UI/system/components/justep/row/row" class="x-row"
              xid="row3" style="padding:0px;margin:0px;min-height:23px;" bind-visible='($model.getColunmname("originalbill")+$model.getColunmname("housename")+$model.getColunmname("orderid"))!=""'> 
              <div class="x-col x-col-fixed x-col-center  fontcss" xid="col20"
                style="width:38%;" bind-html="$model.getColunmname(&quot;originalbill&quot;)==&quot;&quot;?&quot;&quot;:$model.getColunmname(&quot;originalbill&quot;)+$model.schedulePickData.val(&quot;originalbill&quot;)"/>  
                
              <div class="x-col x-col-fixed x-col-center  fontcss" xid="col38" style="width:30%;" bind-html="$model.getColunmname(&quot;housename&quot;)==&quot;&quot;?&quot;&quot;:$model.getColunmname(&quot;housename&quot;)+$model.schedulePickData.val(&quot;housename&quot;)" /><div class="x-col x-col-fixed x-col-center   fontcss" xid="col26"
                style="width:30%;" bind-html="$model.getColunmname(&quot;orderid&quot;)==&quot;&quot;?&quot;&quot;:$model.getColunmname(&quot;orderid&quot;)+$model.schedulePickData.val(&quot;orderid&quot;)"/> 
            </div>  
            <div component="$UI/system/components/justep/row/row" class="x-row"
              ...
              <div class="x-col x-col-fixed x-col-center  fontcss" xid="col35" style="width:62%;" bind-html="$model.getColunmname(&quot;customername&quot;)==&quot;&quot;?&quot;&quot;:$model.getColunmname(&quot;customername&quot;)+$model.schedulePickData.val(&quot;customername&quot;)" /><div class="x-col x-col-fixed x-col-center   fontcss" xid="col39"
                style="width:30%;" bind-html="$model.getColunmname(&quot;operate_time&quot;)==&quot;&quot;?&quot;&quot;:$model.schedulePickData.val(&quot;operate_time&quot;)==undefined?&quot;&quot;:$model.getColunmname(&quot;operate_time&quot;)+ justep.Date.toString($model.schedulePickData.val(&quot;operate_time&quot;), justep.Date.STANDART_FORMAT_SHOT)"/> 
            </div>  
            <div component="$UI/system/components/justep/row/row" class="x-row"
              xid="row6" style="padding:0px;margin:0px;min-height:23px;" bind-visible='$model.getColunmname("remark")!="" '> 
                
              <div class="x-col x-col-fixed x-col-center   fontcss" xid="col36"
                style="width:100%;" bind-html="$model.getColunmname(&quot;remark&quot;)==&quot;&quot;?&quot;&quot;:$model.getColunmname(&quot;remark&quot;)+$model.schedulePickData.val(&quot;remark&quot;)"/> 
            </div>  
            <div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true"
              altRows="false" class="x-grid-title-center center-block" xid="grid1"
              data="schedulePickDetailData" headerMenu="hideColumn,setColumn,saveLayout"
              ...
              <columns xid="columns1"> 
                <column name="goods_number" xid="column2" align="center" sortable="false"
                  width="40"/>  
                <column name="imgurl" xid="column1" align="center" hidden="true" sortable="false"/>  
                ...
                <column name="price" xid="column9" align="center" sortable="false"/>  
                <column name="total" xid="column11" align="center" sortable="false"
            ...
            <div component="$UI/system/components/justep/row/row" class="x-row"
              xid="row5" style="padding:0px;margin-top:5px;min-height:25px;" bind-visible="($model.getColunmname(&quot;mcount&quot;)+$model.getColunmname(&quot;mtotal&quot;))!=&quot;&quot;"> 
              <div class="x-col x-col-fixed x-col-center  fontcss" xid="col2"
                style="width:50%;" bind-html="$model.getColunmname(&quot;mcount&quot;)==&quot;&quot;?&quot;&quot;:($model.getColunmname(&quot;mcount&quot;)+$model.schedulePickData.val(&quot;count&quot;))"/>  
              <div class="x-col x-col-fixed x-col-center  fontcss" xid="fcol22"
                style="width:50%;" bind-html="$model.getColunmname(&quot;mtotal&quot;)==&quot;&quot;?&quot;&quot;:$model.getColunmname(&quot;mtotal&quot;)+$model.schedulePickData.val(&quot;total&quot;)"/> 
            </div>  
            <div component="$UI/system/components/justep/row/row" class="x-row"
              xid="signnamerow" style="padding:0px;margin-left:0px;margin-top:2px;min-height:25px;"
              bind-visible='$model.getColunmname("signname1") +$model.getColunmname("signname2")+$model.getColunmname("staffname")+$model.getColunmname("create_by") !=""'> 
              <div class="x-col x-col-fixed x-col-center  fontcss" xid="col4"
                style="width:25%;" bind-text="$model.getColunmname(&quot;signname1&quot;)"/>  
              <div class="x-col x-col-fixed x-col-center  fontcss" xid="col3"
                style="width:25%;" bind-html="$model.getColunmname(&quot;signname2&quot;)"/>  
              <div class="x-col x-col-fixed x-col-center   fontcss" xid="col37" style="width:25%;" bind-html='$model.getColunmname("staffname")==""?"":$model.getColunmname("staffname")+($model.pdata.val("staffname")==1?$model.schedulePickData.val("staffname"):"")' /><div class="x-col x-col-fixed x-col-center   fontcss" xid="col21" style="width:25%;" bind-html='$model.getColunmname("create_by")==""?"":$model.getColunmname("create_by")+($model.schedulePickData.val("create_by")!=undefined&amp;&amp; $model.pdata.val("create_by")==1?$model.schedulePickData.val("create_by").split("[")[0]:"")' /></div> 
          </div> 
        </div> 
      </div> 
    </div> 
  ...
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver"
    ...
    <div class="x-popOver-content" xid="div3"> 
      <div xid="contentdiv" class="listpop" style="width:350px;"> 
        <div xid="div5" bind-text="&quot;排产领料单列别名设置&quot;" align="center" style="font-size:16px;font-weight:bold;margin:10px;"/>  
        ...
        <div xid="notshowdiv" style="color:blue;">
   <span component="$UI/system/components/justep/button/checkbox" class="x-checkbox" xid="staffnamecheckbox" label="显示经手人内容" checked="true" checkedValue="1" uncheckedValue="0" value="1" bind-ref='$model.pdata.ref("staffname")'></span>
   <span component="$UI/system/components/justep/button/checkbox" class="x-checkbox" xid="create1" label="显示制单人内容" checked="true" checkedValue="1" uncheckedValue="0" value="1" bind-ref='$model.pdata.ref("create_by")'></span></div></div>  
